<?php 
	...
	$regNo=$_SESSION["user"];
	$btnLabel="activate";
	$label="Activate Application Window";
	$period=$conn->query("SELECT * FROM ApplicationPeriod") or die($conn->error);
	$appPeriod=$period->fetch_assoc();
	if($appPeriod["status"]=="Open"){
		$btnLabel="deactivate";
		$label="Deactivate Application Window";
	}
	...
	if (isset($_POST["deactivate"])) {
		$openingDate=$_POST["openingDate"];
		$closingDate=$_POST["closingDate"];
		if($conn->query("UPDATE ApplicationPeriod SET status='Closed', openingDate='$openingDate', closingDate='$closingDate'")){
			// echo "<script>alert('Application Window Deactivated')</script>";
			header("refresh:0");
...
<body>
	<main class="container-fluid">
		...
		<section class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<center><h2>Application Window</h2></center>
				</div>
			</div>
			<div class="row">
				...
				<div class="side-nav" style="border: solid black red;">
					...
					<!-- <li><a class="active" href="applicationList.php">Application List</a></li>
					  ...
					  <li><a href="applicationWindow.php" ><b>Application Window</b></a></li>
				...
				<div class="col-md-9">
					...
					<div class="panel panel-danger">
						<div class="panel-heading"><h3><?php echo $label; ?></h3></div>
						<div class="panel-body">
							<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
								<div class="form-group">
									<label>From</label>
									<input type="date" name="openingDate" class="form-control" value="<?php echo $appPeriod["openingDate"]; ?>">
								</div>
								<div class="form-group">
									<label>To</label>
									<input type="date" name="closingDate" class="form-control" value="<?php echo $appPeriod["closingDate"]; ?>">
								</div>
								<br>

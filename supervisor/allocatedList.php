		...
		<section class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<?php
						$all=$conn->query("SELECT A.*,S.* FROM Allocated A INNER JOIN Student S ON A.reg_no=S.reg_no");
						if ($all->num_rows>0) {
							?>
						<table class="table table-all" id="myTable">
							...
							<form class="" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
									...
									<td><?php echo "Year ".$row["yearAllocated"]; ?></td>
							...
							echo "No students have been allocated accommodation";
						}
					 ?>
				</div>
			</div>

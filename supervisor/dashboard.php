<?php 
	...
	include 'autoDeactivateApplicationPeriod.php';
	include 'autoDeactivateRoomBookingPeriod.php';
	$regNo=$_SESSION["user"];
...
<body>
	<main class="container-fluid">
		...
		<section class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					<center><h2>Supervisor Dashboard</h2></center>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-9">
					<div class="row" style="height: 100%;">
						<br>
						<div class="col-md-5 btn-primary" style="border-radius: 10px;">
							<center><a href="messages.php" style="color: white;text-decoration: none;"><h2><span class='glyphicon glyphicon-envelope'></span><br>Messages</h2>
								<h3>
									<?php
									$unreadMessages=$conn->query("SELECT COUNT(message) AS noOfUnreadMessages FROM Message WHERE reg_no='$regNo' AND viewed='0'") or die("Messages Could not be viewd<br>".$conn->error);
					  		if (($unreadMessages->num_rows)>=1) {
						...
						<div class="col-md-5 btn-danger" style="border-radius: 10px; margin-left: 10px;">
							<center><a href="applicationList.php" style="color: white;text-decoration: none;"><h2><br>Application List</h2>
								<h3 style="color: red;"><br></h3></a></center>
						</div>
					</div> 
						<!-- row -->
					<div class="row" style="height: 100%;">
						<br>
						<div class="col-md-5 btn-success" style="border-radius: 10px;">
							<center><a href="allocatedList.php" style="color: white;text-decoration: none;"><h2><br>Selection List</h2>
								<h3>
									<?php
									$unreadMessages=$conn->query("SELECT COUNT(reg_no) AS noOfUnreadMessages FROM Allocated") or die("Messages Could not be viewd<br>".$conn->error);
					  		if (($unreadMessages->num_rows)>=1) {
					  			$unreadMessage=$unreadMessages->fetch_assoc();
						...
						<div class="col-md-5 btn-info" style="border-radius: 10px; margin-left: 10px;">
							<center><a href="applicationWindow.php" style="color: white;text-decoration: none;"><h2><br>Application Period</h2>
								<h3 style="color: red;" id="status"><?php 
						...
						<!-- row -->
						<div class="row">
						<div class="col-md-5 btn-primary" style="border-radius: 10px; margin-top: 15px;">
							<center><a href="roomBookings.php" style="color: white;text-decoration: none;"><h2><br>Room Bookings</h2>
								<h3 style="color: red;display: none;" id="bStatus"><?php 
						...
						<div class="col-md-5 btn-warning" style="border-radius: 10px; margin-left: 10px;">
							<center><a href="" style="color: white;text-decoration: none;color: #ffbf6c;"><h2><br>Dashboard Items</h2>
								<h3>5</h3></a></center>
						</div>
					</div>
				</div>

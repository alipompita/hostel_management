				...
				<div class="col-md-9">
					<div class="row" style="height: 100%;">
						...
						<div class="col-md-5 btn-primary" style="border-radius: 10px; margin-top: 15px;">
							<center><a href="roomBooking.php" style="color: white;text-decoration: none;"><h2><br>Room Bookings</h2>
						...
						<div class="col-md-5 btn-warning" style="border-radius: 10px; margin-left: 10px;">
							<center><a href="" style="color: white;text-decoration: none;"><h2><br>Dashboard Items</h2>
								<h3>3</h3></a></center>
						</div>
					</div>
					<div class="row">
